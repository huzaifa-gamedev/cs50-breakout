...
-- Check if the random number is less than or equal to 40
if randomChance <= 40 then
    -- Pick a random brick and set its key property to true
    local randomBrickIndex = math.random(1, #bricks)
    bricks[randomBrickIndex].key = true
end
